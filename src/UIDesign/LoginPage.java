...
public class LoginPage{
    ...
    public static String username, toAddUser;
    public static char[] password;
    protected static JLabel loginInfo;
    public static boolean adminInformation;
    ...
    private JPanel setLoginPanel (int width, int height) {
        ...
        formsPanel.add(SharedComponents.Labels.getLabel("Username: ", 20));
        formsPanel.add(usernameField);
        formsPanel.add(SharedComponents.Labels.getLabel("Password: ", 20));
        formsPanel.add(passwordField);

        loginInfo = SharedComponents.Labels.getLabel("", 20);
        loginInfo.setPreferredSize(new Dimension(250, 25));

        loginButton = SharedComponents.Buttons.getButton("Login");
